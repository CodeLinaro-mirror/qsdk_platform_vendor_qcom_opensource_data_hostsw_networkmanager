...
#define NMT_8021X_FIELDS_GET_PRIVATE(o) \
    (G_TYPE_INSTANCE_GET_PRIVATE((o), NMT_TYPE_8021X_FIELDS, Nmt8021xFieldsPrivate))
...
nmt_8021x_fields_constructed(GObject *object)
{
    ...
    Nmt8021xFieldsPrivate *priv    = NMT_8021X_FIELDS_GET_PRIVATE(object);
...
nmt_8021x_fields_set_property(GObject      *object,
                              ...
                              GParamSpec   *pspec)
{
    Nmt8021xFields        *fields = NMT_8021X_FIELDS(object);
    Nmt8021xFieldsPrivate *priv   = NMT_8021X_FIELDS_GET_PRIVATE(fields);
...
{
    Nmt8021xFields        *entry = NMT_8021X_FIELDS(object);
    Nmt8021xFieldsPrivate *priv  = NMT_8021X_FIELDS_GET_PRIVATE(entry);
...
nmt_8021x_fields_class_init(Nmt8021xFieldsClass *entry_class)
{
    ...
    g_type_class_add_private(entry_class, sizeof(Nmt8021xFieldsPrivate));
