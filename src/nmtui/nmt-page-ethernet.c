...
#define NMT_PAGE_ETHERNET_GET_PRIVATE(o) \
    (G_TYPE_INSTANCE_GET_PRIVATE((o), NMT_TYPE_PAGE_ETHERNET, NmtPageEthernetPrivate))
...
nmt_page_ethernet_constructed(GObject *object)
{
    ...
    priv->s_8021x = g_object_ref_sink(s_8021x);
...
nmt_page_ethernet_class_init(NmtPageEthernetClass *ethernet_class)
{
    ...
    g_type_class_add_private(ethernet_class, sizeof(NmtPageEthernetPrivate));
