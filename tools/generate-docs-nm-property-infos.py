...
def get_file_infos(source_files):
    ...
    for priority, setting_names, source_file in file_infos:
        yield source_file, setting_names
...
keywords = {
    ...
    "variable": KEYWORD_XML_TYPE_NODE,
    "format": KEYWORD_XML_TYPE_NODE,
    "values": KEYWORD_XML_TYPE_NODE,
    "default": KEYWORD_XML_TYPE_NODE,
    "example": KEYWORD_XML_TYPE_NODE,
    "description": KEYWORD_XML_TYPE_NODE,
...
def write_data(setting_node, line_no, parsed_data):
    ...
    with f:
        ...
        for line in f:
            ...
            if just_had_end_tag:
                ...
                write_data(setting_node, line_no_start, parsed_data)
                lines = None
...
def process_settings_docs(tag, output, source_files):
    ...
    for source_file, setting_names in get_file_infos(source_files):
